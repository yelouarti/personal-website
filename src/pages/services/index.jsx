...
import spiderChartBig from "../expertise/assets/spider-chart.svg";
...
const Services = () => {
    ...
    return (
        <div>
            <MainTemplateHero title={t("services.hero.title")}
                              tagline={t("services.hero.tagline")}
                              image={spiderChartBig}
                              backgroundColor="#4A8C7F"
                              textColor="#F5F5F5"
            />
